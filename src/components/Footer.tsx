        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="grid grid-cols-2 gap-3 xs:gap-4 sm:gap-6 md:grid-cols-4 md:gap-8 lg:gap-12">
            ...
            <div className="col-span-1 md:col-span-1">
              <h3 className="text-[10px] xs:text-xs sm:text-sm md:text-base lg:text-lg font-display font-bold text-white mb-1.5 sm:mb-2 whitespace-nowrap overflow-hidden text-ellipsis">CLAUSE INTERIOR FITS</h3>
              <p className="text-[8px] xs:text-[9px] sm:text-xs md:text-sm text-slate-300 mb-2 sm:mb-3 whitespace-nowrap overflow-hidden text-ellipsis">Where Function Meets Aesthetics</p>
              <div className="flex flex-wrap gap-1.5 xs:gap-2 sm:gap-3">
                <a href="https://www.instagram.com/clausedesigninteriorfits/?igsh=cWdjYm1qdm8zZHhj" target="_blank" rel="noopener noreferrer" className="w-6 h-6 xs:w-7 xs:h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 bg-gradient-to-r from-pink-500 to-purple-600 rounded-lg flex items-center justify-center hover:scale-110 transition-transform">
                ...
                <a href="https://www.facebook.com/people/Clause-Interior-fits-and-design/100091929919157/?rdid=qVrdHzdRb532AyUa&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F14Tu5azcVpa%2F" target="_blank" rel="noopener noreferrer" className="w-6 h-6 xs:w-7 xs:h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 bg-blue-600 rounded-lg flex items-center justify-center hover:scale-110 transition-transform">
                  <svg className="w-3 h-3 xs:w-3.5 xs:h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </a>
                <a href="https://x.com/ClauseFits47910?t=XBC90QhLlI2zfnuIlfntpw&s=09" target="_blank" rel="noopener noreferrer" className="w-6 h-6 xs:w-7 xs:h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 bg-black rounded-lg flex items-center justify-center hover:scale-110 transition-transform">
                  <svg className="w-3 h-3 xs:w-3.5 xs:h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                  </svg>
                </a>
                <a href="https://wa.me/254701403851" target="_blank" rel="noopener noreferrer" className="w-6 h-6 xs:w-7 xs:h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 bg-green-500 rounded-lg flex items-center justify-center hover:scale-110 transition-transform">
                  <svg className="w-3 h-3 xs:w-3.5 xs:h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://www.tiktok.com/@clauseinteriorfitsndesig?_r=1&_t=ZM-91kJYTvC2Ey" target="_blank" rel="noopener noreferrer" className="w-6 h-6 xs:w-7 xs:h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 bg-black rounded-lg flex items-center justify-center hover:scale-110 transition-transform">
                  <svg className="w-3 h-3 xs:w-3.5 xs:h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="col-span-1 md:col-span-1">
              ...
              <ul className="space-y-0.5 sm:space-y-1 text-[9px] xs:text-[10px] sm:text-xs md:text-sm text-slate-300">
                ...
                <li><a href="#projects" className="hover:text-orange-500 transition-colors whitespace-nowrap">Projects</a></li>
                <li><a href="#contact" className="hover:text-orange-500 transition-colors whitespace-nowrap">Contact</a></li>
              </ul>
            </div>
            ...
            <div className="col-span-1 md:col-span-1">
              ...
              <ul className="space-y-0.5 sm:space-y-1 text-[9px] xs:text-[10px] sm:text-xs md:text-sm text-slate-300">
                ...
                <li className="whitespace-nowrap">Gypsum Ceilings</li>
                <li className="whitespace-nowrap">Office Partitions</li>
              </ul>
            </div>
            ...
            <div className="col-span-1 md:col-span-1">
              ...
              <div className="space-y-1 sm:space-y-1.5 text-[9px] xs:text-[10px] sm:text-xs md:text-sm text-slate-300">
                <div className="flex items-start">
                  ...
                  <span className="whitespace-nowrap overflow-hidden text-ellipsis">+254 701 403851</span>
                </div>
                <div className="flex items-start">
                ...
                <div className="flex items-start">
                  ...
                  <span className="whitespace-nowrap overflow-hidden text-ellipsis">Oginga Odinga Street, Kisumu</span>
                </div>
              </div>
            </div>
          </div>
          
          <div className="border-t border-slate-700 pt-8 mt-12 text-center text-xs xs:text-sm md:text-base text-slate-400">
