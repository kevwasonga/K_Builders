...
const ExpandableServiceCard = ({ title, category, location, description, image, fullDescription }: ServiceCardProps) => {
  ...
  const shareOptions = [
    { 
      ...
      action: () => window.open(`https://wa.me/?text=${encodedMessage}%20${window.location.href}`, '_blank') 
    },
    { 
      name: 'Facebook', 
      icon: (
    ...
    { 
      ...
      action: () => window.open('https://instagram.com/clauseinteriorfits', '_blank') 
    },
    { 
      name: 'TikTok', 
      icon: (
      ...
      action: () => window.open('https://tiktok.com/@clauseinteriorfits', '_blank') 
    },
    { 
      name: 'X (Twitter)', 
      icon: (
      ...
      action: () => window.open(`https://twitter.com/intent/tweet?text=${encodedMessage}&url=${window.location.href}`, '_blank') 
    },
    { 
      name: 'LinkedIn', 
      icon: (
      ...
      action: () => window.open(`https://www.linkedin.com/sharing/share-offsite/?url=${window.location.href}`, '_blank') 
    },
    { 
      name: 'Email', 
      icon: <Mail size={20} />, 
      action: () => window.location.href = `mailto:?subject=${encodeURIComponent(title)}&body=${encodedMessage}%20${window.location.href}` 
    },
    { 
      name: 'Copy Link', 
      icon: (
      ...
      action: () => { navigator.clipboard.writeText(window.location.href); alert('Website link copied to clipboard!'); } 
    }
  ];
  ...
  const ctaOptions = [
    { 
      ...
      action: () => window.open(`https://wa.me/254701403851?text=${encodedMessage}`, '_blank') 
    },
    { 
      name: 'Instagram DM', 
      icon: (
    ...
    { 
      ...
      action: () => window.open('https://m.me/clauseinteriorfits', '_blank') 
    },
    { 
      name: 'TikTok', 
      icon: (
    ...
    { 
      ...
      action: () => window.open('https://twitter.com/clauseinteriorfits', '_blank') 
    },
    { 
      name: 'Phone Call', 
      icon: <Phone size={20} />, 
      action: () => window.location.href = 'tel:+254701403851' 
    },
    { 
      name: 'Email', 
      icon: <Mail size={20} />, 
      action: () => window.location.href = `mailto:Clauseinteriorfits@gmail.com?subject=${encodeURIComponent(title)}&body=${encodedMessage}` 
    }
  ];
