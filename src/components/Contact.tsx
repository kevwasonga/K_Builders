    ...
    <section id="contact" className="py-20 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-slate-800 mb-4 font-serif">Get In Touch</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-lg text-center shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-slate-800 mb-2 font-serif">Phone</h3>
          ...
          <div className="bg-white p-8 rounded-lg text-center shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-slate-800 mb-2 font-serif">Email</h3>
          ...
          <div className="bg-white p-8 rounded-lg text-center shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-slate-800 mb-2 font-serif">Office</h3>
