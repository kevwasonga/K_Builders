      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-6 sm:gap-8 mb-5 sm:mb-7 md:mb-10">
          ...
          <div className="card-elegant">
            ...
            <h3 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl font-display font-bold text-slate-800 mb-4">Our Story</h3>
            <p className="text-sm xs:text-base sm:text-lg md:text-xl text-slate-600 leading-relaxed">
          ...
          <div className="card-elegant">
            ...
            <h3 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl font-display font-bold text-slate-800 mb-4">Our Mission</h3>
            <p className="text-sm xs:text-base sm:text-lg md:text-xl text-slate-600 leading-relaxed">
          ...
          <div className="card-elegant">
            ...
            <h3 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl font-display font-bold text-slate-800 mb-4">Our Vision</h3>
            <p className="text-sm xs:text-base sm:text-lg md:text-xl text-slate-600 leading-relaxed">
