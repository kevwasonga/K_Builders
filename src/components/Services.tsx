      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            ...
            >
              <div className={`${service.color} ${service.hoverColor} p-6 transition-colors duration-300 relative bg-cover bg-center`} style={{backgroundImage: `url(${service.bgImage})`}}>
